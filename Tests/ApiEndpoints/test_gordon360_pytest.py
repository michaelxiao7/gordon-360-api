...
searchString = '360' #'michael'
searchString2 = 'studenttest' #'lindsay'
...
# This must match line in Gordon360/AuthorizationFilters/StateYourBusiness.cs
...
class testCase:
    ...
    def createAuthorizedSession(self, username, password):
        ...
        authorization_header = "Bearer " + r.json()["access_token"]
